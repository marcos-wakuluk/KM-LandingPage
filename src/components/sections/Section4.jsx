      ...
      <div className="flex flex-col md:flex-row bg-custom-black">
        <div className="content-container md:w-2/3 w-full text-white py-4 px-8 relative">
          ...
          <ul className=" pl-5">
            ...
            <li>
              <h3 className="text-2xl font-semibold mb-4 relative">
                <strong>📋 Método PPR:</strong> Diseñado para mantener tu constancia y sentar bases sólidas para un
                cambio real y sostenible.
              </h3>
            </li>
            <li>
              <h3 className="text-2xl font-semibold mb-4  relative">
                <strong>🤝 Acompañamiento constante:</strong> Estamos siempre disponibles para guiarte y apoyarte
                durante el proceso.
              </h3>
            </li>
            <li>
